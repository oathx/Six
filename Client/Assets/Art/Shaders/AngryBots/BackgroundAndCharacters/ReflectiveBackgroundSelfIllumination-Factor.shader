...
Shader "Self-Illumin/AngryBots/ReflectiveBackgroundSelfIllumination-Factor" {
...
Properties {
	...
	_OneMinusReflectivity("OneMinusReflectivity", Float) = 0.1
}
...
SubShader {
	...
	Pass {
		...
		fixed4 frag (v2f_full i) : COLOR0 
		{
			...
			tex += refl * saturate(tex.g + (tex.g - 0.5) * _OneMinusReflectivity);	
