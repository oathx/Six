...
Shader "KingKong/Scene/BlendReflectTerrainLightmap"
{
	Properties
	{
		_MainTex("Base(RGB)", 2D) = "white" {}
		_Terrain("Terrain(RGB)", 2D) = "white" {}
		_BlendMap("Reflect(R) Illum(G) Terrain(B)", 2D) = "black" {}
