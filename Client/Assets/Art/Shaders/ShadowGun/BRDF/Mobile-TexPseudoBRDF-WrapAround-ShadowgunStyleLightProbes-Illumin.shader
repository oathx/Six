Shader "Mobile/BRDFLit (Supports Backlight, Shadowgun style Light Probes, Illumin)" {
Properties {
	_MainTex ("Base (RGB) Gloss (A)", 2D) = "grey" {}
	_IllumColor ("Illumin Color", Color) = (1, 1, 1, 1)
	_IllumMap ("Illumin Map (Gray)]", 2D) = "black" {}
...
void surf (Input IN, inout MySurfaceOutput o) {
	...
	fixed i = tex2D(_IllumMap, IN.uv_MainTex);
	o.Albedo = tex.rgb;
	o.Gloss = tex.a;
	o.Alpha = tex.a;
	o.Emission = i * _IllumColor.rgb;
